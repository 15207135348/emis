        ...
        <div class="layui-main mag0" style="margin: 0 0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${ctx }/resources/images/face.jpg" class="layui-nav-img userAvatar"
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${ctx }/index/toLogin.action" class="signOut"><i
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${ctx }/resources/page/main.html"><i class="layui-icon"
                                                                                          data-icon=""></i><cite>系统首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="${ctx }/resources/page/main.html"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            url: "${ctx }/menu/get_menu.action" //获取菜单json地址
        });
