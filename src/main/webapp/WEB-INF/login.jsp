...
<body class="loginBody">
	<form class="layui-form" id="loginFrm" method="post" action="${ctx }/login/login.action">
		...
		<div class="layui-form-item input-item">
			...
			<input type="text" placeholder="请输入账户名" autocomplete="off" name="e_account" class="layui-input" lay-verify="required">
		</div>
		<div class="layui-form-item input-item">
			<label for="e_password">密码</label>
			<input type="password" placeholder="请输入密码" autocomplete="off" name="e_password" class="layui-input" lay-verify="required">
		</div>
		<div class="layui-form-item input-item" id="imgCode">
			<label for="code">验证码</label>
			<input type="text" placeholder="请输入验证码" autocomplete="off" id="code" name="code" class="layui-input" lay-verify="required">
			<img src="${ctx}/login/code.action" id="imgCode_image">
		</div>
	...
	layui.use(['form','layer','jquery'],function(){
        ...
        image.onclick = function (ev) {
            image.setAttribute("src", "http://localhost:8080/login/code.action")
			image.update()
		};
	})
